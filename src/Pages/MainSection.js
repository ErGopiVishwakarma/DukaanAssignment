    ...
    <div className='flex flex-col w-full bg-[#FAFAFA]' style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      <div className='flex px-8 py-3  gap-4 border-b-[1px] border-solid border-[#D9D9D9] bg-[#FFF]'>
        ...
        <div className=' w-[100%] gap-2 px-4 flex items-center py-[9px] bg-[#F2F2F2] rounded-md'>
          ...
          <input className='bg-[#F2F2F2] text-[#808080] text-[15px] font-normal leading-[22px] focus:outline-none placeholder-[#808080]' placeholder='search features, tutorial etc' />
      ...
      <div className=' p-8  flex flex-col gap-8'>
        ...
        <div className='flex flex-col gap-6'>
          <div className=' flex justify-between '>
            ...
            <select className=' text-base text-[#4D4D4D] leading-6 border-[1px] border-solid border-[#D9D9D9] bg-[#FFFFFF] rounded h-9 focus:outline-none'>
