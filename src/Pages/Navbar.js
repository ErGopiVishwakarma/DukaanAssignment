...
const Navbar = () => {
  return (
    <div className=' w-56  h-[100vh] flex px-[10px] flex-col bg-[#1E2640] py-4 sticky top-0' style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      {/* middle section  */}
      <div className=' w-full  mt-6 h-full flex flex-col gap-1 '>

        {
          data?.map((el) => {
            return <div className=' flex py-2 px-4  gap-3 rounded opacity-80 font-medium h-9'>
              {el.svg}
      ...
      {/* bottom section  */}
      <div className='flex gap-[10px] items-center bottom-0 py-[6px] px-3 bg-[#353C53] rounded relative w-full  '>
